            ...
            <nav className="bg-gray-900 flex items-center justify-between flex-wrap bg-teal-500 p-6">
                ...
                >
                    <div className="text-sm lg:flex-grow  text-center lg:text-right">
                        <Link href="/">
                            <a className="block mt-4 lg:inline-block lg:mt-0 text-teal-100 hover:text-white mr-4 text-lg">
                                Home
                            </a>
                        </Link>
                        <Link href="/about">
                        ...
                        <Link href="/login">
                            <a
                                href="#"
                                className="inline-block text-sm px-4 py-2 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0 ml-3"
                            >
                                Login/Register
                            </a>
                        </Link>
