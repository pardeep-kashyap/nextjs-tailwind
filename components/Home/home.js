                    ...
                    <div className="flex flex-wrap">
                        <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
                            <div className="px-6">
                                <img
                                    alt="..."
                                    src="https://github.com/creativetimofficial/tailwind-starter-kit/blob/master/Landing%20Page/react-landing-page/src/assets/img/team-1-800x800.jpg?raw=true"
